...
from evaluation.evaluation import evaluate_all_retrieval, evaluate_all_answers
...
def main():
    ...
    with gr.Blocks(title="RAG Evaluation Dashboard", theme=theme) as app:
        ...
        gr.Markdown("Evaluate retrieval and answer quality for the AMEX RAG system")
